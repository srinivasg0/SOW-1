          ...
          <div className="search-section">
            ...
            <div className="action-buttons">
              <button className="action-btn new-product">
                ...
                <span className="desktop-only">{translations['pricelist.new_product'] || 'New Product'}</span>
              </button>
              <button className="action-btn print">
                ...
                <span className="desktop-only">{translations['pricelist.print'] || 'Print List'}</span>
              </button>
              <button className="action-btn advanced">
                ...
                <span className="desktop-only">{translations['pricelist.advanced'] || 'Advanced mode'}</span>
              </button>
            </div>
          </div>
